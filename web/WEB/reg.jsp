            ...
            <div class="row"> 
                <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4"> 
                    ...
                    <form action="../RegController" method="post" class="form" role="form">                       
                        ...
                        <label for="sex"> Giới tính: </label>  <label class="radio-inline">      <input name="sex" id="inlineCheckbox1" value="Nam" type="radio" checked/>          Nam </label> <label class="radio-inline">          <input name="sex" id="inlineCheckbox2" value="Nữ" type="radio"/>          Nữ </label> <label class="radio-inline">          <input name="sex" id="inlineCheckbox2" value="Khác" type="radio"/>          Khác </label>
                        <br> 
                        <br> 
