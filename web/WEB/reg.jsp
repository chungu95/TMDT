            ...
            <div class="row"> 
                <div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4"> 
                    ...
                    <form action="../RegController" method="post" class="form" role="form"> 
                        ...
                        <input class="form-control" name="retypepassword" placeholder="Nhập lại mật khẩu" type="password" id="retypepassword"/> <label for=""> Ngày sinh</label> 
                        <div class="row"> 
                            <div class="col-xs-4 col-md-4"> <select class="form-control" name = "Day">              <option value='01'>1</option>
                            ...
                            <div class="col-xs-4 col-md-4"> <select class="form-control" name="Month">              <option value='01'>1</option>
                                    <option value='02'>2</option>
                                    <option value='03'>3</option>
                                    <option value='04'>4</option>
                                    <option value='05'>5</option>
                            ...
                            <div class="col-xs-4 col-md-4"> <select class="form-control" name="Year">              <option value='1901'>1901</option>
                        ...
                        </div><label for="sex"> Giới tính: </label>  <label class="radio-inline">      <input name="sex" id="inlineCheckbox1" value="male" type="radio" checked/>          Nam </label> <label class="radio-inline">          <input name="sex" id="inlineCheckbox2" value="female" type="radio"/>          Nữ </label> 
                        <br> 
                        <br> 
